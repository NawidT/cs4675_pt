            ...
            <FormControl variant="outlined" size="small">
              ...
              >
                ...
                {server_url.startsWith("http://localhost") && (
                  <>
                    <MenuItem value="llama3.2">llama3.2 (local)</MenuItem>
                    <MenuItem value="llama3.1">llama3.1 (local)</MenuItem>
                    <MenuItem value="llama2">llama2 (local)</MenuItem>
                    <MenuItem value="deepseek-r1">deepseek-r1 (local)</MenuItem>
                  </>
                )}
              </Select>
            </FormControl>
